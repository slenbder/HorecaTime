...
-- Дефолтные значения вставляются при init_database(); INSERT OR IGNORE для миграции существующих БД.
-- Позиции с extra_rate: Бармен (350/500), Барбэк (250/400), Раннер (200/300).
-- Прочие ставки: Официант (250), Хостесс (200), Менеджер (350), Горячий цех (280),
--   Холодный цех (250), Кондитерский цех (280), Заготовочный цех (230), Коренной цех (230),
--   Су-шеф (500), Грузчик (180), Закупщик (180), Клининг (200), Котломой (200).
