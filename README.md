...
- **Позиции с повышенной ставкой** — Раннер (выходные), Бармен/Барбэк (свыше 60ч + AH)
...
- **Защита от formula injection** — `value_input_option="RAW"` для всех пользовательских данных
- **Plain text для TG_ID** — предотвращает научную нотацию и рассинхрон при switch_month
