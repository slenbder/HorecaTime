...
| E (5) | Позиция | Официант/Раннер/Бармен/... Для "Руководящий состав" — записывается `custom_title` (напр. "Бренд-шеф"), иначе `position` |
...
- **A:** ФИО
- **B:** Telegram ID
- **C:** Позиция (или custom_title для Руководящий состав)
